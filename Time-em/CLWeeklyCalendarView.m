...
static float const CLCalendarSelectedDatePrintFontSizeDefault = 15.f;
...
-(void)applyCustomDefaults
{
    ...
    self.dayTitleTextColor = [UIColor blackColor];
...
//        _dayTitleSubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0, DATE_TITLE_MARGIN_TOP, self.bounds.size.width, DAY_TITLE_VIEW_HEIGHT)];
        _dayTitleSubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0, 15+DAY_TITLE_VIEW_HEIGHT+DATE_VIEW_MARGIN, self.bounds.size.width, DAY_TITLE_VIEW_HEIGHT)];
...
-(UIView *)dailySubViewContainer
{
    if(!_dailySubViewContainer){
        _dailySubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0,10, self.bounds.size.width, DATE_VIEW_HEIGHT)];
...
-(UIImageView *)backgroundImageView
{
    ...
    _backgroundImageView.backgroundColor =[UIColor colorWithRed:246.0f/255.0f green:246.0f/255.0f blue:246.0f/255.0f alpha:1];
